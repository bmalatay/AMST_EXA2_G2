              ...
              return Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Card(
                      color: Colors.blueGrey.shade600, // Fondo gris claro
                      child: ListTile(
                          title: Text(
                            heroes?[index]['name'],
                            style:
                                TextStyle(color: Colors.white), // Letras azules
                          ),
                          onTap: () {
                            int heroId =
                                int.parse(heroes![index]['id'].toString());
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => HeroProfilePage(
                                        heroId.toString() as String)));
                          }),
                    );
                  },
                ),
